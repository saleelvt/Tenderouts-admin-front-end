          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="bg-green-100">
                ...
                <th className="border border-gray-300 px-4 py-2">Prices (All Categories)</th>
            ...
            <tbody>
              {packages.map((pkg) => (
                <tr key={pkg._id} className="text-center hover:bg-green-50">
                  ...
                  <td className="border border-gray-300 px-4 py-2 text-xs whitespace-normal break-words">
                    {pkg.description || "—"}
                  </td>
                  <td className="border border-gray-300 px-4 py-2">{pkg.adultCount}</td>
                  <td className="border border-gray-300 px-4 py-2">{pkg.childCount}</td>

                  {/* Show all category prices inside this cell */}
                  <td className="border border-gray-300 px-4 py-2 text-sm">
                    <div className="flex flex-col gap-1 text-left">
                      <span>
                        <strong>Normal:</strong> Adult ₹{pkg.categories.Normal.adult}, Child ₹
                        {pkg.categories.Normal.child}
                      </span>
                      <span>
                        <strong>Premium:</strong> Adult ₹{pkg.categories.Premium.adult}, Child ₹
                        {pkg.categories.Premium.child}
                      </span>
                      <span>
                        <strong>Luxury:</strong> Adult ₹{pkg.categories.Luxury.adult}, Child ₹
                        {pkg.categories.Luxury.child}
                      </span>
                    </div>
                  </td>
